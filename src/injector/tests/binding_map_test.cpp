...
TEST(insertDefault_success) {
  ...
  injdet::Binding* binding = bindingMap.lookupBinding<prez::injector::Unannotated>(TYPE_ID_0);
...
TEST(insertMultipleDifferentAnnotations_success) {
  ...
  injdet::Binding* binding0 = bindingMap.lookupBinding<prez::injector::Unannotated>(TYPE_ID_0);
...
TEST(insertMultipleDifferentTypeDefault_success) {
  ...
  injdet::Binding* binding0 = bindingMap.lookupBinding<prez::injector::Unannotated>(TYPE_ID_0);
  injdet::Binding* binding1 = bindingMap.lookupBinding<prez::injector::Unannotated>(TYPE_ID_1);
  injdet::Binding* binding2 = bindingMap.lookupBinding<prez::injector::Unannotated>(TYPE_ID_2);
...
TEST(lookupDifferentType_returnsNullptr) {
  bindingMap.insertBinding<prez::injector::Unannotated>(
      TYPE_ID_0, any(OBJ_0), false, BINDING_TYPE, LOC);
  injdet::Binding* binding = bindingMap.lookupBinding<prez::injector::Unannotated>(TYPE_ID_1);
