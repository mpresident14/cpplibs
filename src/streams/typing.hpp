...
// using cond_tuple_empty_t = std::conditional_t<std::tuple_size_v<Tuple> == 0,
// IfEmpty, Else>;
...
// template <typename PrevTuple>
// struct last_arg {
//   using type = std::tuple_element_t<std::tuple_size_v<PrevTuple> - 1,
//   PrevTuple>;
// };
...
//         std::tuple_size_v<Tuple> == 0 ? 0 : std::tuple_size_v<Tuple> -
//         Trim>>::type;
